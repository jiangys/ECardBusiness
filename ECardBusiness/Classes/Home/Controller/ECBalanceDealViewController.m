...
@interface ECBalanceDealViewController ()<UITableViewDataSource, UITableViewDelegate>
@property(nonatomic, strong) UITableView *tableView;
@property(nonatomic, strong) NSMutableArray *balanceArray;
@end

@implementation ECBalanceDealViewController
