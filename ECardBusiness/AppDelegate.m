...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //ECLoginViewController *homeVc = [[ECLoginViewController alloc] init];
    // ECRegisterViewController *vc = [[ECRegisterViewController alloc] init];
    ECHomeViewController *homeVc = [[ECHomeViewController alloc] init];
    self.window.rootViewController = [[ECNavigationController alloc] initWithRootViewController:homeVc];
...
//    keyboardManager.shouldShowToolbarPlaceholder = YES; // 是否显示占位文字
    ...
    keyboardManager.keyboardDistanceFromTextField = 65.0f; // 输入框距离键盘的距离
